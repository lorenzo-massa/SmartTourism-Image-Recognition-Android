...
ldu, doublereal *vt, integer *ldvt, doublereal *work, integer *lwork,
    ...
    extern /* Subroutine */ int dgelqf_(integer *, integer *, doublereal *,
            ...
            dbdsqr_(char *, integer *, integer *, integer *, integer *,
                    ...
                    integer *, doublereal *, integer *, doublereal *, integer *), dorgbr_(char *,
                                                                                          integer *,
                                                                                          integer *,
                                                                                          integer *,
                                                                                          doublereal *,
    ...
    extern /* Subroutine */ int dormbr_(char *, char *, char *, integer *,
                                        ...
                                        integer *), dorglq_(integer *, integer *, integer *,
                                                            doublereal *, integer *, doublereal *,
                                                            doublereal *, integer *,
                                                            integer *), dorgqr_(integer *,
                                                                                integer *,
                                                                                integer *,
                                                                                doublereal *,
                                                                                integer *,
...
/* Computing MAX */
                    i__2 = wrkbl, i__3 = *n * 3 +
                                         *n * ilaenv_(&c__1, "DORGBR", "Q", n, n, n, &c_n1);
                    wrkbl = max(i__2, i__3);
...
/* Computing MAX */
                    i__2 = wrkbl, i__3 = *m * 3 +
                                         *m * ilaenv_(&c__1, "DORGBR", "Q", m, m, m, &c_n1);
                    wrkbl = max(i__2, i__3);
                    wrkbl = max(wrkbl, bdspac);
/* Computing MAX */
                    i__2 = *m * *m + wrkbl, i__3 = *m * *m + *m * *n + *m;
...
/*                 Copy R to WORK(IR) and zero out below it */
                    ...
                    i__2 = *n - 1;
                    i__3 = *n - 1;
                    dlaset_("L", &i__2, &i__3, &c_b421, &c_b421, &work[ir + 1], &ldwrkr);
...
/*                    (Workspace: need N*N+4*N, prefer N*N+3*N+N*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("Q", n, n, n, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *n;
...
/*                    (Workspace: need 2*N*N+4*N, prefer 2*N*N+3*N+N*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("Q", n, n, n, &work[iu], &ldwrku, &work[itauq], &work[iwork], &i__2,
                                &ierr);
...
/*                                prefer 2*N*N+3*N+(N-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("P", n, n, n, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *n;
...
/*                    (Workspace: need M*M+4*M, prefer M*M+3*M+(M-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("P", m, m, m, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *m;
...
/*                                prefer 2*M*M+3*M+(M-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("P", m, m, m, &work[iu], &ldwrku, &work[itaup], &work[iwork], &i__2,
                                &ierr);
...
/*                    (Workspace: need 2*M*M+4*M, prefer 2*M*M+3*M+M*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        dorgbr_("Q", m, m, m, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *m;
