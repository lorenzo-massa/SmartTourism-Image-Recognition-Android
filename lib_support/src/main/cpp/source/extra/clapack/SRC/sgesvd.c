...
/* Subroutine */ int sgesvd_(char *jobu, char *jobvt, integer *m, integer *n,
    ...
    *, integer *, real *, real *, integer *, integer *, real *,
                                                      integer *, integer *), sgeqrf_(integer *,
                                                                                     integer *, real
                                                                                     *, integer *,
                                                                                     real *, real *,
                                                                                     integer *,
                                                                                     integer *), slacpy_(
            char
            *, integer *, integer *, real *, integer *, real *, integer *), slaset_(char *,
                                                                                    integer *,
                                                                                    integer *,
                                                                                    real *, real *,
                                                                                    real *,
            ...
            char *, integer *, integer *, integer *, real *, integer *, real *, real *, integer *,
            integer *), sormbr_(char *, char *,
...
/* Computing MAX */
                    i__2 = wrkbl, i__3 = *n * 3 +
                                         *n * ilaenv_(&c__1, "SORGBR", "Q", n, n, n, &c_n1);
                    wrkbl = max(i__2, i__3);
...
/* Computing MAX */
                    i__2 = wrkbl, i__3 = *m * 3 +
                                         *m * ilaenv_(&c__1, "SORGBR", "Q", m, m, m, &c_n1);
                    wrkbl = max(i__2, i__3);
                    wrkbl = max(wrkbl, bdspac);
/* Computing MAX */
                    i__2 = *m * *m + wrkbl, i__3 = *m * *m + *m * *n + *m;
...
/*                 Copy R to WORK(IR) and zero out below it */
                    ...
                    i__2 = *n - 1;
                    i__3 = *n - 1;
                    slaset_("L", &i__2, &i__3, &c_b421, &c_b421, &work[ir + 1], &ldwrkr);
...
/*                 (Workspace: need N*N+BDSPAC) */
                    ...
                    sbdsqr_("U", n, &c__0, n, &c__0, &s[1], &work[ie], dum, &
                            c__1, &work[ir], &ldwrkr, dum, &c__1, &work[iwork], info);
                    iu = ie + *n;
...
/*                    (Workspace: need N*N+4*N, prefer N*N+3*N+N*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("Q", n, n, n, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *n;
...
/*                    (Workspace: need 2*N*N+4*N, prefer 2*N*N+3*N+N*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("Q", n, n, n, &work[iu], &ldwrku, &work[itauq], &work[iwork], &i__2,
                                &ierr);
...
/*                                prefer 2*N*N+3*N+(N-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("P", n, n, n, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *n;
...
/*                 (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */
                    ...
                    i__2 = *lwork - iwork + 1;
                    sgelqf_(m, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__2, &ierr);
...
/*                 (Workspace: need M*M+BDSPAC) */
                    ...
                    sbdsqr_("U", m, m, &c__0, &c__0, &s[1], &work[ie], &work[
                            ir], &ldwrkr, dum, &c__1, dum, &c__1, &work[iwork], info);
                    iu = ie + *m;
...
/*                 (Workspace: need M*M+2*M, prefer M*M+M+M*NB) */
                    ...
                    i__3 = *lwork - iwork + 1;
                    sgelqf_(m, n, &a[a_offset], lda, &work[itau], &work[iwork], &i__3, &ierr);
...
/*                    (Workspace: need M*M+4*M, prefer M*M+3*M+(M-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("P", m, m, m, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *m;
...
/*                                prefer 2*M*M+3*M+(M-1)*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("P", m, m, m, &work[iu], &ldwrku, &work[itaup], &work[iwork], &i__2,
                                &ierr);
...
/*                    (Workspace: need 2*M*M+4*M, prefer 2*M*M+3*M+M*NB) */
                        ...
                        i__2 = *lwork - iwork + 1;
                        sorgbr_("Q", m, m, m, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2,
                                &ierr);
                        iwork = ie + *m;
